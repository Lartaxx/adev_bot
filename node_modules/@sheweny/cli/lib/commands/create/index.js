...
exports.createProject = exports.getCreateOptions = void 0;
const inquirer_1 = require("inquirer");
const Listr = require("listr");
const execa = require("execa");
const chalk = require("chalk");
const util_1 = require("./util");
async function getCreateOptions(options) {
    ...
    return {
        ...
        token: answers.token,
        git: answers.git,
        handlers: answers.handlers.map((e) => e.toLowerCase()),
    ...
    const tasks = new Listr([
        {
            ...
            task: async () => {
                options = await (0, util_1.createDirProject)(options);
            },
        },
        {
        ...
        },
        {
            ...
            task: async (ctx, task) => {
                ...
                execa("git", ["init", options.dirName]).then((res) => {
                    if (res.failed)
                        return task.skip("An error has occurred");
                });
            },
        },
        {
            ...
            task: async (ctx, task) => {
                try {
                    await (0, util_1.addInfosPackageJson)(options);
                }
                catch (err) {
        ...
        },
        {
            ...
            task: async () => {
                await (0, util_1.copyFiles)(options);
            },
        },
    ]);
    tasks
        .run()
        .then(() => {
        console.log(`\n🎉 Successfully created project ${chalk.yellow(options.dirName)} !\n👉 Get started with the following commands:\n\n ${chalk.grey("$")} ${chalk.blue(`cd ${options.dirName}`)}\n${options.packageManager
