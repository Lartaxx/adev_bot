...
exports.getAddOptions = void 0;
const inquirer_1 = require("inquirer");
const applicationCommandType_1 = require("./applicationCommandType");
async function getAddOptions(options) {
    ...
    const answers = await (0, inquirer_1.prompt)([
        ...
        },
        {
            ...
            when: (answers) => options.addType === "command" && answers.commandType === "ApplicationCommand",
        },
        {
            type: "input",
    ...
    return {
        ...
        commandOptions: {
            applicationCommandType: (0, applicationCommandType_1.applicationCommandType)(answers.applicationCommandType),
...
exports.getAddOptions = getAddOptions;
